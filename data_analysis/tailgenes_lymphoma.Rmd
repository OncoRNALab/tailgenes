...
for (repeat_x in 1:num_repeats) {
  ...
  sample_annotation$cancer_binary <- ifelse(sample_annotation$Disease=="no",0,1)
...
for (cancer in c("DLBCL","PMBCL")) {
  ...
  for (repeat_x in 1:num_repeats) {
    ...
    sample_annotation_selected$cancer_binary <- ifelse(sample_annotation_selected$Disease=="no",0,1)
    # make stratified folds of cancer vs control and get the 5 test sets
