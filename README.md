...
- Tail gene analyses (generated by `tailgenes_*.R` scripts):
  ...
  - *\*_zscores_tail.txt*: table containing the mRNA z-transformed abundance - based on mean and stdev of entire control reference excluding the sample itself - for every sample of cohort \*
